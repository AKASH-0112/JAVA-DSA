...
public class _2nQunees_2 {

    static boolean isSafe(int row  ,int col ,char[][] board){

        // ------------- not need to check for alll horizontal , upper right ,bottom right bcz there will newver be any queeen
        // if u want u can but for optimisation purpose
    ...
    public static void main(String[] args) {
        ...
        System.out.println(allBoards.size()); ///////*******print just size */
...
// but it also so much work to do for nQunnw2 , which is not required
// hashing also there 
// relation of 130 diagonal row col also there